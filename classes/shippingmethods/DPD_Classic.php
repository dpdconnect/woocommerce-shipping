...
class DPD_Classic extends \WC_Shipping_Method
{
    /**
    ...
    public function __construct($instance_id = 0)
    {
        ...
        $this->method_title       = __('DPD Classic', 'dpdconnect');
        $this->method_description = __('B2B Classic DPD shipment', 'dpdconnect');
        $this->supports           = [
            'shipping-zones',
            'settings',
            'instance-settings',
    ...
    public function init()
    {
        ...
        $this->instance_form_fields = include 'includes/settings-dpd-classic.php';

        $this->init_form_fields();
        $this->init_settings();

        $this->enabled              = $this->get_option('enabled');
        $this->title                = (empty($this->get_option('title'))) ? 'DPD Classic Shipment' : $this->get_option('title');
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            'enabled' => [
                ...
                'type' => 'checkbox',
                'description' => __('Enable DPD Classic.', 'dpdconnect'),
                'default' => 'yes'
            ],
            'title' => [
